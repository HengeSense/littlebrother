...
companies = re.compile(ur'''\b('''
	...
	ur'''|агентство|агетства|агентством|агентстве'''          # etc
	ur'''|группа|группы|группу|группой|группе'''
	ur'''|холдинг|холдинга|холдингу|холдингом|холдинге'''
	ur'''|банк|банка|банку|банком|банке'''
	ur''')\s+["«]'''
	ur'''([^\s].+?[^\s])'''                         # «ВЕКТОР-4+»
	ur'''["»]''',
